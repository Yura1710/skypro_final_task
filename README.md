Опечатки:
На главной странице вместо: 
-Основные Инструменты мы видим Основныые Интрументы, 
-Тестирование мы види Тетирование WEB-приложений,
-Командная строка Windows мы видим Командная строка Windos
-
